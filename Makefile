...
$(SRCDIR)/and-2: $(SRCDIR)/and-2.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/and-3: $(SRCDIR)/and-3.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/and-4: $(SRCDIR)/and-4.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/and-5: $(SRCDIR)/and-5.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/and-6: $(SRCDIR)/and-6.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/and-7: $(SRCDIR)/and-7.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o
...
$(SRCDIR)/asr-2: $(SRCDIR)/asr-2.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/asr-3: $(SRCDIR)/asr-3.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/asr-4: $(SRCDIR)/asr-4.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o
...
$(SRCDIR)/b-1: $(SRCDIR)/b-1.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/bic: $(SRCDIR)/bic.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o

$(SRCDIR)/bic-1: $(SRCDIR)/bic-1.s
	$(AS) -o $@.o $<
	$(LD) -o $@ $@.o
